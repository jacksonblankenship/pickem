...
const betOptionVariants = cva(
  'flex w-full items-center justify-between gap-2 rounded-lg border px-3 py-2 transition-all duration-200 active:opacity-80 active:transition-opacity active:duration-75 disabled:pointer-events-none',
  {
    variants: {
      gameState: {
